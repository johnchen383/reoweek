...
export function Results({ choices, onRestart }: ResultsProps) {
  ...
  return (
    <div className="done">
      ...
      <div className="done__eyebrow">Unichurch · ReOWeek '26</div>
      ...
      <button
        type="button"
        className="button button--primary done__restart"
        onClick={onRestart}>
        Play again
      </button>
