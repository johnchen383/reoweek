...
/**
 * /api/responses/:id
 *   GET   - fetch a single response — admin, or the contactee it's assigned to
 *   PUT   - attach survey answers to an existing response
 *   PATCH - update follow-up state — admin edits everything; a contactee may
 *           only edit rows assigned to them and cannot reassign the contactee
 */
